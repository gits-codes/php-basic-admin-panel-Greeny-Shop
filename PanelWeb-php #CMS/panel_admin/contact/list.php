<?php
$list_contact = list_contact_admin();
?>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card custom-card">
            <div class="card-body">
                <h6 class="card-title">لیست تماس ها</h6>
                <p class="text-muted mb-3">تمامی تماس ثبت شده</p>
                    ...
                    <table class="table custom-table">
                        ...
                        <?php foreach ($list_contact as $contact): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="dashbord.php?m=contact&p=detail&id=<?= $contact['id'] ?>">
                                        <button class="btn btn-edit"><i class="bi bi-pencil-fill"></i>نمایش</button>
                                    </a>
                                </td>
                                <td>
                                    <a href="contact/delete.php?m=contact&id=<?= $contact['id'] ?>" style="text-decoration: none;">
