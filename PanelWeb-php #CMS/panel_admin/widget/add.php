    ...
    <style>
        * { box-sizing: border-box; margin:0; padding:0; }
        ...
        .form-wrapper {
            ...
            align-items: center;
            padding: 20px;
            transform: translateY(-80px); /* حدود 100px بالاتر */
        }
    ...
    <div class="form-card">
        ...
        <form method="post" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                ...
                <input type="text" name="frm[title]" class="form-control" placeholder="مثلا: . . ." required>
            </div>
            <div class="form-group">
                <label>توضیحات</label>
            ...
            <div class="text-center">
                <button type="submit" name="btn" class="btn btn-primary">ثبت ویجت</button>
