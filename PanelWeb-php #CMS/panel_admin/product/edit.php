...
if (isset($_POST['btn'])) {
    ...
    edit_show_product($data, $path, $id);
}
?>
            ...
            <div class="card-body">
                ...
                <div class="table-header">
                    ...
                    <a href="dashbord.php?m=product&p=add">
                        <button class="btn btn-add"><i class="bi bi-plus-lg"></i> افزودن محصول</button>
                    </a>
                </div>

                <h5 class="card-title">ویرایش محصول: <?= $result['title'] ?></h5>
                ...
                <form method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="frm[title]" class="form-control" required
                               value="<?= $result['title'] ?>" placeholder="مثلاً: اسپری عطر Oud Mood">
                    </div>
                    ...
                    <div class="form-group">
                        <label>قیمت</label>
                        <input type="number" name="frm[price]" class="form-control" placeholder="قیمت را وارد کنید" value="<?= $result['price'] ?>" required>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="frm[procat]" class="form-control">
                            ...
                            <?php
                            $pro_cat = procat();
                            foreach ($pro_cat as $subs) {
                                echo "<option value=\"$subs[id]\" ";
                                if ($result['procat'] == $subs['id']) echo " selected ";
