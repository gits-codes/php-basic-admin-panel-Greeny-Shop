...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card custom-card">
            <div class="card-body">
                <h6 class="card-title">لیست اخبار</h6>
                <p class="text-muted mb-3">تمامی اخبار ثبت شده</p>
                ...
                <div class="table-responsive">
                    <table class="table custom-table">
                        ...
                        <tbody>
                        <?php foreach ($list_news as $pro): ?>
                            <tr>
                                <td><?= $pro['title']; ?></td>

                                <td>
                                    <?= select_news_cat_with_id($pro['news_cat']); ?>
                                </td>
                                <td>
                                    <?= $pro['date']; ?>
                                </td>
                                ...
                                <td>
                                    <a href="dashbord.php?m=news&p=edit&id=<?= $pro['id'] ?>">
                                        <button class="btn btn-edit"><i class="bi bi-pencil-fill"></i>ویرایش</button>
                                    </a>
                                </td>

                                <td>
                                    <a href="news/delete.php?m=news&id=<?= $pro['id'] ?>" style="text-decoration: none;">
