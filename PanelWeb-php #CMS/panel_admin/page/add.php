...
if (isset($_REQUEST['btn'])) {
    $data = $_REQUEST['frm'];
//    $dir = "Site+1/images/uploader_from_news/";
//    $folders = "-news-".rand();
//    $path = uploader_pic('img',"../Site+1/images/uploader_from_news/",$data['title'].$folders,"news");
    add_pages($data);
    ...
    <div class="form-card">
        ...
        <form method="post" enctype="multipart/form-data" autocomplete="off">
            <div class="form-group">
                ...
                <input type="text" name="frm[title]" class="form-control" placeholder="" required>
            </div>
            <div class="form-group">
                <label>کلمات کلیدی</label>
                <input type="text" name="frm[keyword]" class="form-control" required>
            </div>
            <div class="form-group">
                <label>توضیحات</label>
                <textarea name="frm[description]" id="editors" class="form-control" placeholder="توضیح کوتاهی درباره آن وارد کنید..."></textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="frm[body]" class="form-control" placeholder=""></textarea>
            </div>


            <div class="text-center">
                <button type="submit" name="btn" class="btn btn-primary">ثبت</button>
