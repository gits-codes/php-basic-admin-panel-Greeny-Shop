...
<!-- Mirrored from rtl-temp.ir/Theme/Zinzer/vertical-rtl/advanced-menu.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jun 2019 05:46:07 GMT -->
<head>
        <meta charset="utf-8" />
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list nav-user">
                                    ...
                                    aria-haspopup="false" aria-expanded="false">
                                        ...
                                        <span class="d-none d-md-inline-block ml-1">آقای کاربر وردپرس <i class="mdi mdi-chevron-down"></i> </span>
                                    </a>
                                ...
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        <div class="row align-items-center">
                                            <div class="col-md-8">
                                                <h4 class="page-title m-0">محدوده کشویی</h4>
                                            </div>
                                            <div class="col-md-4">
                                ...
                                <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title">فرم پایه</h6>


                                            <form class="forms-sample">
                                                <div class="mb-3">
                                                    <label for="exampleInputUsername1" class="form-label">نام کاربری</label>
                                                    <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="نام کاربری">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="password" class="form-control" id="exampleInputPassword1" autocomplete="off" placeholder="رمز عبور">
                                                </div>
                                                <div class="mb-auto form-check">
                                                    <input type="checkbox" class="form-check-input" id="checkDefault">
                                                    <label for="checkDefault" class="form-label">رمز عبور</label>
                                                        چک باکس پیش فرض
