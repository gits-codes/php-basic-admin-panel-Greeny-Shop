...
$id = $_REQUEST['id'];
//var_dump($id);
$result = show_menu_edit($id);
if (isset($_REQUEST['btn'])) {
    $data = $_REQUEST['frm'];
    edit_show_menu($data,$id);
            ...
            <div class="card-body">
                ...
                <form method="post" class="forms-sample" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label">آدرس منو</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="frm[url]" value="<?php echo $result['url']; ?>" placeholder="آدرس منو را وارد کنید">
                        </div>
                    </div>
